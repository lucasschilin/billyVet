...
if(isset($_POST['botao']) && $_POST['botao']=="Cadastrar"){
	...
	$cControle = new ControleVeterinario();
    ...
    foreach($validacao as $validacaoo){
	    ...
	    if($validacaoo->getCrmv()==($_POST['crmv'])){
	    	$validoCrmv=false;
	    	break;
	    }

}
	if($validoEmail and $validoCpf and $validoCrmv ){
...
<head>
    ...
    <title>Cadastrar novo Veterinário</title>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="container-fluid">
	...
	<body>
		<h1 style="margin-left: 10px">Cadastro Veterinário</h1>
 <style type="text/css">
    .espacamento{
      padding: 1px;
      margin-left: 4px;
	...
	<div >
		<form action="cadVeterinario.php" method="post" class="form-horizontal"> 
			<div class="row">
				<div div style="margin-left: 2%" class="col-2 espacamento">
				    	<label for="nome_">Nome<text style="color:red;">*</text> : </label>
				</div>
				<div class="col-9 espacamento">
						<?php
			                echo "<input type='text' class='form-control' id='nome_' name='nome' required value='".$dados_temp[0]."'>";
			            ?>
			  	</div>
			</div>
			<br>
			<div class="row">
		  		<div div style="margin-left: 2%" class="col-2 espacamento">
		   				<label for="email_">E-mail <text style="color:red;">*</text> : </label>
		   		</div>
		   		<div class="col-9 espacamento">
			 			<?php
			           		echo "<input type='email' class='form-control' id='email_' name='email' required value='".$dados_temp[1]."'>";
			            ?>
		  		</div>
			</div>
			<br>
			<div class="row">
				<div div style="margin-left: 2%" class="col-2 espacamento">
			   	...
			   	<div class="col-9 espacamento">
					<?php
			           	echo "<input type='text' class='form-control' id='telefone_' name='telefone' required value='".$dados_temp[2]."'>";
			        ?>
			  	</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-9 espacamento">
					<?php
			           	echo "<input type='text' class='form-control' id='cpf_' name='cpf' required value='".$dados_temp[3]."'>";
			        ?>
			  	</div>
			</div>
			<br>
        	...
        	<div class="row">
				...
				<div class="col-9 espacamento">
				    <?php
		           		echo "<input type='text' class='form-control' name='crmv' required value='".$dados_temp[5]."'>";
		            ?>
		  		</div>
		   	</div>
		   	<br>
			  	<div class="date">
				    ...
				    <div class="col-9 espacamento">
				    	<input type="date" class="form-control" id="dt_nasc"  name="dt_nasc" required="true" max="<?=date('Y-m-d')?>">
				    </div>
				</div>
			</div>
      		<br>
			<div class="row">
				...
				<div class="col-9 espacamento">
						<?php
			            	echo "<input type='text' class='form-control' name='nivel_form' required value='".$dados_temp[6]."'>";
			            ?>
		 ...
		 <div class="form-group">
		 	<div div style="margin-left: 2%" class="col-2 espacamento">
			<input type='submit' name='botao' class='btn btn-primary' value='Cadastrar'>
			</div>
		</div>
