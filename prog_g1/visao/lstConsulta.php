...
include_once $_SERVER['DOCUMENT_ROOT']."/prog_g1/desenv/controle/ControleConsulta.class.php";

$cConsulta = new ControleConsulta();
$consultas = $cConsulta->listarTodosPorUsuario();
?>
...
<div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
	...
	<tbody>
      ...
      <th scope="row"></th>
      <td><?php echo $consulta->getLaudo(); ?></td>
	  <td><?php echo $consulta->getObservacao();?></td>
	  <td><?php echo $consulta->getHorarioConsulta();?></td>
					...
					<?php }	?>
	<?php	}else{ echo "Não há nenhuma consulta";
		
	}	?>
  </table>
   <br>
<a class="btn btn-primary" href="lstAgendamento.php" role="button">Listar Agendamentos</a>
