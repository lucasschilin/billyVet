...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	...
	<body>
		<br>
		<br>
		<form method="post" style="text-align:center;" action = "processaAltSenha.php" class="form-controle my-2 my-lg-0 ml-lg-3">
			<div class="form-controle my-2 my-lg-0 ml-lg-3">
				<h1>Alterar a senha </h1>
				Senha Atual:<span style="color:red;">*</span><input class="form-controle my-2 my-lg-0 ml-lg-3" type="password" name="senhaAtual" value="" required> <br> <br>
				Nova Senha:<span style="color:red;">*</span><input class="form-controle my-2 my-lg-0 ml-lg-3" type="password" name="senhaNova" value="" required> <br> <br>
				Confirmar Senha:<span style="color:red;">*</span><input  class="form-controle my-2 my-lg-0 ml-lg-3" type="password" name="confirmSenha" required> <br> <br>
				<input type="submit" class="btn btn-primary my-2 my-sm-0" name="botao" value="Alterar">
