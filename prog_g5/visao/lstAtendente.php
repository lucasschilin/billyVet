...
$atendentes = $cContato->listarTodos();
?>
<html>
<head>
	...
	<script type="http://192.168.103.223/prog_img/verum.png"></script>
...
$(document).ready(function(){
	$("#pesquisar").on("keyup", function() {
		...
		$("#tabela .pesquisar").filter(function() {
			$(this).parent().toggle($(this).text().toLowerCase().indexOf(value) > -1)

		});
	});

	// terminou de carregar, vamos chamar a função pela primeira vez
	$("#pesquisar").trigger("keyup");
});
</script>
</head>
<script>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="container-fluid">
			<div class="row align-items-start mt-2">
				<div class="col-10">
					<h1>Atendentes
						<a href="FormularioUsuario.php"><img src="http://192.168.103.223/prog_img/cadastrar.png" class="image-fluid" width="30" height="30"></a>
					</h1>
				</div>
				<div class="col-2 pr-2">
					<form class="form-inline" action="lstAtendente.php" method="get">
						<input class="form-control" type="text" placeholder="Pesquisar por nome" aria-label="Pesquisar" id="pesquisar" name="pesquisa">
					</form>
				</div>
			</div>
						...
						if($atendentes!=false){
							foreach($atendentes as $atendente){
								...
								<tr>
									...
									echo"<a href='lstUm.php?id_usuario=".$atendente->getId()."'>".$atendente-> getNome()."</td>";
									echo "<td>".$atendente-> getEmail()."</td>";
									...
									//echo "<td>"
									echo "<td>"."<a href='editarAtendente.php?id=".$atendente->getId()."'> <img src='http://192.168.103.223/prog_img/editar.png' width= '25' height='25' >"."</a>"."</td>";
									//echo "</td>"
									//echo"</td>"
								}
								?>
