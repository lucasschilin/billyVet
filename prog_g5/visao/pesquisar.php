...
$atendentes = $cContato->listarNome($pesquisa);
...
confirma = confirm("Tem certeza que deseja sair?");
		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			...
			<?php if($_SESSION['tipo'] == 1){  ?>
			 ...
			 <li class="nav-item dropdown active">
				...
				<li class="nav-item active">
					<a class="nav-link" href="../../../prog_g6/desenv/internacao.php" id="navbarDropdownMenuLink" >
						Internações
					</a>
				</li>
				<li class="nav-item dropdown active">
	...
	<div class="container-fluid">	
		<a href="FormularioUsuario.php"><img src="adicionar.png" align="right" class="media-object  img-responsive img-thumbnail"></a>
	<a href="pesquisar.php"><img src="pesquisar.png" align="right" class="media-object  img-responsive img-thumbnail"></a>
	<br>
	...
	//lista de atendente
		if($atendentes!=false){
			foreach($atendentes as $atendente){
				...
				//echo "<td>"
				echo "<td>"."<a href='editarAtendente.php?id=".$atendente->getId()."'> <img src='editar.png'>  </a>"."</td>";
				//echo "</td>"
				//echo"</td>"
				}
				?>
