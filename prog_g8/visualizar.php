...
<html>
    ...
    <head>
        <?php 
            echo "<title>Visualizar registro de ".$infos['pet']."</title>";
        ?>
		...
		<form>
			<div class="form-group">
				...
				echo "<input name='id_internacao' type='hidden' value='".$_GET['id']."'>";
  				...
  				echo "<h1>Registro de ".$infos['pet']." - Quarto ".$infos['quarto']." <a href='editar.php?id_registro=".$registro->getId_registro()."&id_internacao=".$registro->getId_internacao()."'> <img src='../../prog_img/editar.png' style='width:25px'></a></h1> ";
  				?>
  				...
  				<div>
  					<div class="row">
    					...
    					<div class="col-9 espacamento">
    						<textarea name="procedimento" style='margin-left:2%' class="form-control noresize" rows="4" disabled><?php echo $registro->getProcedimento(); ?></textarea>
    					</div>
    				</div>
	  				...
	  				<div class="row">
    					...
    					<div class="col-9 espacamento">
    						<?php
    						echo "<input class='form-control' style='margin-left:2%' size='145%' type='text' id='idMedicamento' name= 'medicamento' disabled value='".$registro->getMedicamento()."'>";
    						?>
    					</div>
    				</div>
  				 	...
  				 	<div class="row">
    					...
    					<div class="col-9 espacamento">
    						<?php
    						echo"<input class='form-control' style='margin-left:2%' size='145%' type='text' id='idReacoes' name= 'reacao' disabled value='".$registro->getReacao()."'>";
    						?>
  						</div>
  					</div>
					...
					<div class="container-fluid">
  					...
  					<div class="row">
						...
						<div class="col-9 espacamento">
							<?php
							echo "<input class='form-control' style='margin-left:2%'' size='145%' name='dt_procedimento' disabled value='".$registro->getdt_procedimento()."' disabled>";
							?>
						</div>
  					</div>
                             ...
                             echo "<div class='form-group form-check'>";
                                echo"<label class='form-check-label' name='visibilidade' for='idVisibilidade'>Visível</label>";
  								if($registro->getVisibilidade()==0){
  									echo"<input type='checkbox' style='margin-left:2%' class='form-check-input' id='idVisibilidade'  name= 'visibilidade' disabled value=0>";	
  								}else{
  									echo"<input type='checkbox' style='margin-left:2%' class='form-check-input' id='idVisibilidade'  name= 'visibilidade' checked disabled value=1>";	
  								}
