...
if(isset($_POST['botao']) && $_POST['botao']=="Editar"){
    $ccControle = new ControlePaciente();
    $paciente = $ccControle->alterar($_POST);
    $cControle = new ControleUsuario();
    $usuario = $cControle->alterar($_POST);
...
<html>
	<head>
		<title>Alteração de cadastro de Paciente</title>
		<meta charset="UTF-8">
	...
	<body>
		...
		<div class="container-fluid">
			<form action="editPaciente.php" method="post"> 
				...
				<div class="form-row">
				    	...
				    	<div class="col" style="width: 100%">
				      		<?php
	               			 echo "<input type='text' class='form-control mr-sm-2 id='nomepaciente' name='nomepaciente' required value='".$paciente->getNomepaciente()."'>";
	          		  	 	?>
				      	</div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
					  	<?php
		            	 echo "<input type='text' class='form-control mr-sm-2 id='dt' name='dt' required value='".$paciente->getDt()."'>";
		          		?>
				  	</div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
			       		<?php
						echo "<input type='text' class='form-control mr-sm-2 id='raca' name='raca' required value='".$paciente->getRaca()."'>";
	          		  	?>
				    </div>
				</div>
				<div class="form-row">
				...
				<div class="form-row" id='possuiPlano'>
				    <div class="col-2">
				    	<label class= 'control-label' style="margin-left: 10px; margin-top: 12px;"> Nome do plano de saúde: </label>
				    </div>
				    <div class="col" style="width: 100%">
				    	<?php 
				    	echo "<input placeholder='Plano de saúde' type='text' id='nomePlano' name='nomePlano' placeholder='Nome do plano de saúde' class='form-control mr-sm-2' value='".$paciente->getPlano()."'>";
				    	?>
				    </div>
			    </div>
				...
				<div class="form-row">
	          	...
	          	<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
				    	<?php
	               		echo "<input type='text' class='form-control mr-sm-2 id='nome' name='nometutor' required value='".$usuario->getNometutor()."'>";
	            		?>
				    </div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
				      	<?php
	                	echo "<input type='email' class='form-control mr-sm-2 id='email' name='email' required value='".$usuario->getEmail()."'>";
	           			?>
				    </div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
				      	<?php
	                	echo "<input type='text' class='form-control mr-sm-2 id='celular' name='celular' required value='".$usuario->getCelular()."'>";
	           			?>
				    </div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
				    	<?php
	                	echo "<input type='text' class='form-control mr-sm-2 id='cpf' name='cpf' required value='".$usuario->getCPF()."'>"; 
	                	?>
				    </div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
				      	<?php
	                	echo "<input type='text' class='form-control mr-sm-2 id='cep' name='cep' required value='".$paciente->getCEP()."'>";
	           				?>        	
				    </div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
				      	<?php
	                	echo "<input type='text' class='form-control mr-sm-2 id='bairro' name='bairro' required value='".$paciente->getBairro()."'>";
	           			?>
				    </div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
				      	<?php
	                	echo "<input type='text' class='form-control mr-sm-2 id='logradouro' name='logradouro' required value='".$paciente->getLogradouro()."'>";
	           			?>
				    </div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
				      	<?php
	                	echo "<input type='text' class='form-control mr-sm-2 id='ncasa' name='ncasa' required value='".$paciente->getNcasa()."'>";
	           				?>
				    </div>
				</div>
				<div class="form-row">
				    ...
				    <div class="col" style="width: 100%">
				      	<?php
	                	echo "<input type='text' class='form-control mr-sm-2 id='complemento' name='complemento' required value='".$paciente->getComplemento()."'>";
	           			?>
				    </div>
				</div>
				<div class="form-row">
	            ...
	            <input type='submit' name='botao' value='Editar' class='btn btn-primary my-2 my-sm-0' style="margin-left: 10px;">
	            <input id='voltar' type='button' name='botao' value='Voltar' class='btn btn-primary my-2 my-sm-0'>
	   		</form>
	    </div>	
    </body>
    <script>
