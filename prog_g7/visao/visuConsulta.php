<?php  
	...
	$consultas = $cConsulta->VisualizarConsulta($_GET);
?>
<html>
	<head>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-10">
				<div class="form-group">
				    <?php echo "<input type='text' class='form-control' name='paciente' value='".utf8_encode($consultas->getNome_paciente())."' disabled>" ?>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-lg-10">
				<div class="form-group">
				    <?php echo "<input type='text' class='form-control' name='veterinario' value='".utf8_encode($consultas->getNome_veterinario())."' disabled>" ?>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<div class="form-group">
				    <label for="data">Data da Realização:</label>
				</div>
			</div>
			<div class="col-lg-10">
				<div class="form-group">
				    <?php 
				    	$date = explode(" ", $consultas->getHorarioConsulta());
				    	echo "<input type='date' class='form-control' name='data' value='".$date[0]."' disabled>"; 
				    ?>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<div class="form-group">
				    <label for="hora">Hora da Realização:</label>
				</div>
			</div>
			<div class="col-lg-10">
				<div class="form-group">
				    <?php 
				    	$date = explode(" ", $consultas->getHorarioConsulta());
				    	echo "<input type='time' class='form-control' name='hora' value='".$date[1]."' disabled>"; 
				    ?>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col">					
				<div class="form-group">
				    <label for="laudo">Laudo:</label><br>
				    <textarea name='laudo' class='form-control noresize' rows='4' disabled><?php echo $consultas->getLaudo(); ?></textarea>
				</div>
			</div>
		</div>	
		<div class="row">
			<div class="col">					
				<div class="form-group">
				    ...
				    <textarea name='obs' class='form-control noresize' rows='4' disabled><?php echo $consultas->getObservacao(); ?></textarea>
				</div>
			</div>
		</div>
	</div>
